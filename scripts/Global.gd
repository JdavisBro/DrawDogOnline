...
const hat_ims = {'Bandana': 0, 'Beanie': 1, 'Brimcap': 2, 'Strawhat': 3, 'Sunhat': 4, 'Headband': 8, 'Bow': 9, 'Antenna': 12, 'Flower': 13, 'Howdy': 14, 'Shades': 15, 'Tinted Shades': 16, 'Line Shades': 17, 'Big Shades': 18, 'Beret': 19, 'Rex Head': 20, 'Wielder Wrap': 21, 'Newsie': 22, 'Half-Moons': 23, 'Round Glasses': 24, 'Square Glasses': 25, 'Pointish Glasses': 26, 'Spellcaster': 27, 'Backwards': 28, 'Feather': 29, 'Ahoy': 30, 'Delivery': 31, 'Earmuffs': 32, 'Clown': 33, 'Wintry': 34, 'Eyepatch': 35, 'Gnome': 36, 'Mascot Head': 37, 'Spike Helmet': 38, 'Big Fungus': 39, 'Nautical': 40, 'Fungus': 41, 'Goggles': 42, 'Chef': 43, 'Foxy': 44, 'Sparkles': 45, 'Aviators': 46, 'Beak': 47, 'Rim Shades': 48, 'Bell': 49, 'Elf': 50, 'Gardener': 51, 'Stache': 52, 'Monocle': 53, 'Stormy': 54, 'Superstar': 55, 'Headphones': 78, 'Headscarf': 79, 'Skate Helmet': 80, 'Mask': 81, 'Top Hat': 82, 'Helm': 83, 'Beard': 84, 'Crown': 85, 'Earflaps': 86, 'Tiara': 87, 'Horns': 88, 'Horns_1': 89}
...
var dog_dict = {"clothes": "Overalls", "hat": "Bandana", "hair": "Simple", "color": {"body": Color.WHITE, "hat": Color.WHITE, "clothes": Color.WHITE}}
